...
wget --no-cookie --no-check-certificate -e robots=off https://ftp.gnu.org/gnu/mpfr/mpfr-4.1.0.tar.gz
wget --no-cookie --no-check-certificate -e robots=off https://ftp.gnu.org/gnu/mpc/mpc-1.2.0.tar.gz
wget --no-cookie --no-check-certificate -e robots=off https://ftp.gnu.org/gnu/gcc/gcc-9.3.0/gcc-9.3.0.tar.gz
wget --no-cookie --no-check-certificate -e robots=off https://ftp.gnu.org/gnu/gmp/gmp-6.2.0.tar.bz2
