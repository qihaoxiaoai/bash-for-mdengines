...
export LD_LIBRARY_PATH=/home/xhshi/hjx/software-self/lammps-simple/env/fftw338s/lib:$LD_LIBRARY_PATH
export BLAS=/home/xhshi/hjx/software-self/lammps-simple/env/lib/libfblas.a
export LAPACK=/home/xhshi/hjx/software-self/lammps-simple/env/lib/liblapack.a
...
wget --no-cookie --no-check-certificate -e robots=off https://github.com/plumed/plumed2/archive/refs/tags/v${PLUMED_VERSION}.zip
